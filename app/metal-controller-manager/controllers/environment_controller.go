...
func (r *EnvironmentReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	if req.Name == metalv1alpha1.EnvironmentDefault {
		if err := ReconcileEnvironmentDefault(ctx, r.Client, r.TalosRelease, r.APIEndpoint); err != nil {
...
func ReconcileEnvironmentDefault(ctx context.Context, c client.Client, talosRelease, apiEndpoint string) error {
	...
	if apierrors.IsNotFound(err) {
		...
		env.Spec = *metalv1alpha1.EnvironmentDefaultSpec(talosRelease, apiEndpoint)
